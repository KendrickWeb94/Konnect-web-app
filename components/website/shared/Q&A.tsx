  ...
  export function AccordionDemo() {
    return (
      <div className=" min-h-screen w-full justify-center pt-16 flex-col space-y-7 items-center">
        <h1 className=" from-slate-600 to-slate-400 bg-gradient-to-r bg-clip-text text-transparent text-clip text-center font-extrabold lg:text-4xl text-3xl text-balance">
          FAQs
        </h1>
